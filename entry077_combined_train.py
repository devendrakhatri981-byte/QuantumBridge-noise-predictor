...
import entry077_train_gnn as base

CKPT_PATH = "quantumbridge_data/entry077_combined_ckpt.json"
DEPLOY_PATH = "quantumbridge_data/entry077_combined_params.json"
RESULTS_PATH = "quantumbridge_data/entry077_combined_results.json"
EPOCHS = 100
...
if __name__ == "__main__":
    ...
    per_chip = {}
    for chip in ("kyiv", "sherbrooke", "brisbane", "osaka"):
        m = chip_test == chip
        if m.sum() == 0:
            continue
