"""
QuantumBridge — Entry 073: eval-only bell-pair dataset for Osaka, the true
...
model (trained on Kyiv+Sherbrooke+Brisbane, zero Osaka exposure) a set of
...
SHOTS = 4096
SEEDS = (1, 2, 3, 4)
OUT_PATH = "quantumbridge_data/entry073_osaka_bell_dataset.json"
BACKENDS = {"osaka": FakeOsaka}
...
def main(target=700, per_bin=None, seed=73, n_workers=4):
