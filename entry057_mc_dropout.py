...
CKPT_PATH = "quantumbridge_data/entry057_mcdropout_ckpt.json"
RESULTS_PATH = "quantumbridge_data/entry057_mcdropout_results.json"
EPOCHS = 100
...
if __name__ == "__main__":
    ...
    CC_CKPT = f"quantumbridge_data/entry057_mcdropout_cc{suffix}_ckpt.json"
    CC_RESULTS = f"quantumbridge_data/entry057_mcdropout_cc{suffix}_results.json"
