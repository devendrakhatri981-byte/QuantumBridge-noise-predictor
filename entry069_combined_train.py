...
CKPT_PATH = "quantumbridge_data/entry069_combined_ckpt.json"
DEPLOY_PATH = "quantumbridge_data/entry069_combined_params.json"
RESULTS_PATH = "quantumbridge_data/entry069_combined_results.json"
EPOCHS = 100
