"""
QuantumBridge — Entry 073: eval-only bell-pair dataset for Kyoto, the true
...
model (trained on Kyiv+Sherbrooke+Brisbane, zero Kyoto exposure) a set of
...
SHOTS = 4096
SEEDS = (1, 2, 3, 4)
OUT_PATH = "quantumbridge_data/entry084_kyoto_bell_dataset.json"
BACKENDS = {"kyoto": FakeKyoto}
...
def main(target=700, per_bin=None, seed=84, n_workers=4):
