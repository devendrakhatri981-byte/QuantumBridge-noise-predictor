"""
QuantumBridge — Entry 053b: cross-chip generalization + floor-collapse check
...
import entry053_train_gnn as base
...
def run(name, train_idx, test_idx, epochs=100, chunk_epochs=25, batch_size=64, lr=3e-3, seed=0):
    ckpt_path = f"quantumbridge_data/entry053_cc_{name}_ckpt.json"
    opt = optax.adam(lr)
...
if __name__ == "__main__":
    ...
    RESULTS_PATH = "quantumbridge_data/entry053_cross_chip_results.json"
