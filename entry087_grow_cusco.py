"""
QuantumBridge — Entry 073: eval-only bell-pair dataset for Cusco, the true
...
model (trained on Kyiv+Sherbrooke+Brisbane, zero Cusco exposure) a set of
...
SHOTS = 4096
SEEDS = (1, 2, 3, 4)
OUT_PATH = "quantumbridge_data/entry087_cusco_bell_dataset.json"
BACKENDS = {"cusco": FakeCusco}
...
def main(target=700, per_bin=None, seed=87, n_workers=4):
