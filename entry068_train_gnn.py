...
MAX_N, MAX_E = 90, 130
IN_PATH = "quantumbridge_data/entry068_graph_dataset.json"
...
FOLD_CKPT = "quantumbridge_data/entry068_gnn_folds.json"
RESULTS_PATH = "quantumbridge_data/entry068_gnn_results.json"
EPOCHS = 100


def train_fold(train_idx, test_idx, seed=0, epochs=EPOCHS, batch_size=64, lr=3e-3, chunk_epochs=25):
    import os
    ckpt_path = f"quantumbridge_data/entry068_fold_tmp_ckpt.json"
    opt = optax.adam(lr)
