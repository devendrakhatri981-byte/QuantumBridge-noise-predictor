"""QuantumBridge — Entry 055: fold the 394 new deduped bell-pair circuits
(from the 2,132->2,152 growth-toward-3,200 round of entry042_parallel_dataset.json)
into the Entry 054 graph dataset (2,811 -> 3,205), reusing graph_for_record unchanged."""
...
NEW_RECORDS_PATH = "quantumbridge_data/entry055_new_bell_only.json"
BASE_GRAPHS_PATH = "quantumbridge_data/entry054_graph_dataset.json"
OUT_PATH = "quantumbridge_data/entry055_graph_dataset.json"
