"""Entry 043: retrain the GNN on the 2,288-circuit dataset -- checkpoint the
improvement curve to decide whether more raw volume is still paying off."""
...
FOLD_CKPT = "quantumbridge_data/entry043_gnn_folds.json"
RESULTS_PATH = "quantumbridge_data/entry043_gnn_results.json"
EPOCHS = 180
