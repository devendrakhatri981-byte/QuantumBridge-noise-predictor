"""QuantumBridge — Entry 053: extend the graph dataset with Entry 052's
60-70-node circuits, reusing Entry 044's graph_for_record unchanged."""
...
IN_PATHS = [
    ...
    "quantumbridge_data/entry052_biggerghz_dataset.json",
]
OUT_PATH = "quantumbridge_data/entry053_graph_dataset.json"
