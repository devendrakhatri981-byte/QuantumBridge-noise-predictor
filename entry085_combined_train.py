...
import entry085_train_gnn as base

CKPT_PATH = "quantumbridge_data/entry085_combined_ckpt.json"
DEPLOY_PATH = "quantumbridge_data/entry085_combined_params.json"
RESULTS_PATH = "quantumbridge_data/entry085_combined_results.json"
EPOCHS = 100
...
if __name__ == "__main__":
    ...
    test_pred = train(train_idx, test_idx, chunk_epochs=20)
    ...
    per_chip = {}
    for chip in ("kyiv", "sherbrooke", "brisbane", "osaka", "quebec"):
        m = chip_test == chip
        if m.sum() == 0:
            continue
