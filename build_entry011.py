...
print(f"Entry 011 dataset (with deconfounded gate-cost data): {df.shape[0]} samples\n")
...
print(f"  Entry 007 (2 features, no SQ gates):        R2=0.747, MAE=0.63")
print(f"  Entry 009 (3 features, confounded SQ data):  R2=0.629, MAE=0.70")
print(f"  Entry 011 (3 features, deconfounded SQ data): R2={r2:.3f}, MAE={mae:.2f}")

df.to_csv("quantumbridge_data/entry011_unified.csv", index=False)
print(f"\nSaved to quantumbridge_data/entry011_unified.csv")
