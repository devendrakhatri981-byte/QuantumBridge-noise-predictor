...
from qiskit_ibm_runtime.fake_provider import FakeKyiv, FakeSherbrooke, FakeBrisbane, FakeOsaka, FakeQuebec
...
BACKENDS = {"kyiv": FakeKyiv, "sherbrooke": FakeSherbrooke, "brisbane": FakeBrisbane, "osaka": FakeOsaka, "quebec": FakeQuebec}
...
def load():
    if os.path.exists(OUT_PATH):
        ...
        d.setdefault("brisbane", []); d.setdefault("osaka", []); d.setdefault("quebec", [])
        return d
    return {"kyiv": [], "sherbrooke": [], "brisbane": [], "osaka": [], "quebec": []}
