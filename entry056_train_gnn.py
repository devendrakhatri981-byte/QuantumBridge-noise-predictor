"""
QuantumBridge — Entry 056: GNN capacity bump #2, 48/64 -> 80/104.
...
42 nodes/56 edges) to 80/104 (fits Entry 056's max: 65 nodes/99 edges,
...
MAX_N, MAX_E = 90, 130
IN_PATH = "quantumbridge_data/entry056_graph_dataset.json"
...
FOLD_CKPT = "quantumbridge_data/entry056_gnn_folds.json"
RESULTS_PATH = "quantumbridge_data/entry056_gnn_results.json"
EPOCHS = 100


def train_fold(train_idx, test_idx, seed=0, epochs=EPOCHS, batch_size=64, lr=3e-3, chunk_epochs=25):
    import os
    ckpt_path = f"quantumbridge_data/entry056_fold_tmp_ckpt.json"
    opt = optax.adam(lr)
